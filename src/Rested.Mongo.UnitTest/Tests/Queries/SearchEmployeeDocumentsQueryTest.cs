...
{
    [TestClass]
    public class SearchEmployeeDocumentsQueryTest :
        SearchMongoDocumentsQueryTest<Employee, SearchEmployeeDocumentsQuery, SearchEmployeeDocumentsQueryValidator, SearchEmployeeDocumentsQueryHandler>
    {
