...
using Rested.Mongo.MSTest.Queries;
...
{
    [TestClass]
    public class SearchEmployeeProjectionsQueryTest :
        SearchMongoProjectionsQueryTest<Employee, EmployeeProjection, SearchEmployeeProjectionsQuery, SearchEmployeeProjectionsQueryValidator, SearchEmployeeProjectionsQueryHandler>
    {
