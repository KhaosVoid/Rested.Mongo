...
{
    [TestClass]
    public class EmployeeMultiDtoCommandTest :
        MultiMongoDtoCommandTest<Employee, EmployeeMultiDtoCommand, EmployeeMultiDtoCommandValidator, EmployeeMultiDtoCommandHandler>
    {
